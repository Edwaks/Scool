...
**Scool** — набор детских обучающих игр. Продукт рассчитан на дети, родители и педагоги и помогает знакомиться с буквами и базовыми понятиями через короткие игровые занятия.

- Публичный адрес: http://scool.botchel.ru/
- Основные сущности: игры, буквы, задания, подсказки, попытки, достижения и учебные темы.
- Ключевые возможности: игры с алфавитом, короткие задания, наглядные подсказки, повторение, мягкая обратная связь, выбор темы и совместное занятие.

## Зачем нужен продукт

Рабочий процесс редко состоит из одного действия. Пользователю приходится понимать исходную ситуацию, собирать сведения, выбирать следующий шаг, согласовывать решение и возвращаться к результату позже. Scool создаёт для этого единое предметное пространство. Оно помогает не терять контекст между этапами и видеть не только отдельную карточку, но и её место в общем процессе.

Главная ценность продукта — не количество экранов, а связность работы. Игры, буквы, задания, подсказки, попытки, достижения и учебные темы рассматриваются как части одного пользовательского маршрута. Благодаря этому новый участник быстрее понимает состояние дела, опытный специалист тратит меньше времени на ручное сопоставление, а руководитель получает обозримую картину без пересказа каждого шага.
...
Роли Ребёнок, Родитель и Педагог работают с одной предметной моделью, хотя видят её с разных сторон. Единые названия объектов и состояний уменьшают двусмысленность при передаче работы. Ответственный участник может сослаться на конкретный объект и ожидаемый результат, а не пересказывать весь контекст.

## Основные разделы

Публичное описание охватывает следующие пользовательские возможности:

- **Игры с алфавитом** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Короткие задания** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Наглядные подсказки** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Повторение** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Мягкая обратная связь** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Выбор темы** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Совместное занятие** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
