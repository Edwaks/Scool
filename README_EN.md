...
**Scool** is a collection of educational games for children. It is designed for children, parents, and educators and introduces letters and basic concepts through short play-based activities.

- Public URL: http://scool.botchel.ru/
- Core entities: games, letters, tasks, hints, attempts, achievements, and learning topics.
- Key capabilities: alphabet games, short tasks, visual hints, practice and repetition, gentle feedback, topic selection, shared activities.

## Why the Product Is Needed

A real workflow rarely consists of a single action. Users must understand the initial situation, gather information, choose the next step, coordinate a decision, and return to the result later. Scool provides one domain-specific environment for this work. It preserves context between stages and shows not only an individual item, but also its place in the overall process.

The product’s main value is not the number of screens, but workflow continuity. Games, letters, tasks, hints, attempts, achievements, and learning topics are treated as parts of one user journey. New participants understand the current state faster, experienced specialists spend less time matching information manually, and managers gain a clear overview without requiring every step to be retold.
...
The roles Child, Parent, and Educator work with the same domain model from different perspectives. Consistent names for objects and states reduce ambiguity during handoffs. A responsible participant can reference a specific object and expected result instead of repeating the entire context.

## Main Sections

The public description covers these user capabilities:

- **Alphabet games** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Short tasks** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Visual hints** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Practice and repetition** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Gentle feedback** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Topic selection** — a distinct part of the workflow, connected to the product model and a clear user outcome.
- **Shared activities** — a distinct part of the workflow, connected to the product model and a clear user outcome.
